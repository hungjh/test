...
function requestVideoUrls(part_format_id, vid, fileName, host, videoCount) {
  var keyApi = "https://vv.video.qq.com/getkey?otype=json&platform=11&format=100701&vid=n0699lfzkef&filename=n0699lfzkef.m701.mp4&appver=3.2.19.333"
  // 
  ...
  return new Promise(function (resolve) {
    wx.request({
      ...
      success: function (resu) {
        ...
        console.log("22",resu.data)
        var dataJson = resu.data.replace(/QZOutputJson=/, '') + "qwe";
